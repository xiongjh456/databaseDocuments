package com.xh.database.documents.utils;
...
public class DocumentsUtil {
    ...
    static void document(){
        ...
        hikariConfig.setJdbcUrl("jdbc:mysql://192.168.0.210:3306/logis");
        hikariConfig.setUsername("logis");
        ...
        EngineConfig engineConfig = EngineConfig.builder()
                //生成文件路径(改成自己的生成路径)
                .fileOutputDir("C:\\Users\\Administrator\\Desktop\\document")
                //生成后是否立即打开目录
                .openOutputDir(true)
